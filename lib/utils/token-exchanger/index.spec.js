  ...
  describe('Token Exchanger', function() {
    ...
    describe('#replaceTokens', function() {
      ...
      it('should not mix tokens when using lot of tokens', function() {
        ...
        const replacedText = tokenExchanger.replaceTokens('token1');
    ...
    describe('replace & revert tokens', function() {
      ...
      it('should revert token what have been replaced in text', function() {
        const tokenExchanger = createTokenExchanger(tokens);
        const replacedText = tokenExchanger.replaceTokens('#token 1#');
        const revertedText = tokenExchanger.revertTokens(replacedText);
